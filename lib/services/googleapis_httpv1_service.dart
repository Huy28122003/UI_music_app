...
class HTTPv1Service{
  static Future<String> getAccessToken() async {
    final serviceAccountJson = {
        ...
        "private_key_id": "9074c902bad8dc2de8e020186eb0694b6eb3505",
  ...
  Future<void> sendFCMMessage() async {
    ...
    final Map<String, dynamic> message = {
      'message': {
        'token': "d34IcBcMQV6hNFdSaQkp3V:APA91bFhNtyWnA2P5GmNmt0ENj_Xyo4On4PJMaO_HL3vpO_A4NqUNLuYN-FhAiYcV9Nvt7oLK4yaWYNhiNC0be0pvw_fPMcWSabFzFO8k0zokxxKUzQhMu4HZ1dojEWHTH2_7FcvzVzZ", // Token of the device you want to send the message to
        'notification': {
